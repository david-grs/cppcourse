...
void Snake::Move()
{
    ...
    mSnakeBody.at(0) = mSnakeBody.at(0) + mMovingDirection;
...
{
    return glm::distance2(cinder::vec2(mSnakeBody.at(0).x + mSnakeBodyPartSize/2, mSnakeBody.at(0).y + mSnakeBodyPartSize/2), cinder::vec2(point.x, point.y));
}
